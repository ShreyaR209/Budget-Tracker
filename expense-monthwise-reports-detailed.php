...
$ret1=mysqli_query($con,"SELECT month(IncomeDate) as rptmonth1,year(IncomeDate) as rptyear1,SUM(IncomeCost) as totalmonth1 FROM income  where (IncomeDate BETWEEN '$fdate' and '$tdate') && (UserId='$userid') group by month(IncomeDate),year(IncomeDate)");
...
?>
                ...
                <tr>
                  ...
                  <td><?php  echo $ttlsl1=$row1['totalmonth1'];?></td>
                  <td><?php  echo $ttlsl1-$ttlsl;?></td>
