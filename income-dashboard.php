	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Income Dashboard</li>
			</ol>
		</div><!--/.row-->

		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Income Dashboard</h1>
			</div>
		</div><!--/.row-->
...
$query1=mysqli_query($con,"select sum(IncomeCost)  as yesterdayincome from income where (IncomeDate)='$ydate' && (UserId='$userid');");
...
$crrntdte=date("Y-m-d");
$query2=mysqli_query($con,"select sum(IncomeCost)  as weeklyincome from income where ((IncomeDate) between '$pastdate' and '$crrntdte') && (UserId='$userid');");
...
$crrntdte=date("Y-m-d");
$query3=mysqli_query($con,"select sum(IncomeCost)  as monthlyincome from income where ((IncomeDate) between '$monthdate' and '$crrntdte') && (UserId='$userid');");
...
$userid=$_SESSION['detsuid'];
 $cyear= date("Y");
$query4=mysqli_query($con,"select sum(IncomeCost)  as yearlyincome from income where (year(IncomeDate)='$cyear') && (UserId='$userid');");
...
$sum_total_income=$result5['totalincome'];
 ?>
					<div class="panel-body easypiechart-panel">
						<h4>Total Income</h4>
						<div class="easypiechart" id="easypiechart-white" data-percent="<?php echo $sum_total_income;?>" ><span class="percent"><?php if($sum_total_income==""){
echo "0";
} else {
